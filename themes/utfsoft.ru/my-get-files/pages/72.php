    ...
    <div class="container">
        <div class="block-1100 mx-auto mb-3 mb-sm-4 mb-md-50 text-center">
            ...
            <p class="mb-0">
                ...
                и правилам в данной сфере, стремиться к оптимизации процессов, действовать с максимальной открытостью и
                гарантировать защиту персональных данных от любых угроз. Основными атрибутами современной системы
                информационной безопасности являются: шифрование, политика безопасности и обучение персонала правилам
                кибербезопасности.
            </p>
        </div>
        <picture class="image">
            <source media="(max-width:430.98px)"
                    srcset="/wp-content/themes/utfsoft.ru/assets/img/pages/72/banner-430.svg">
            <img src="/wp-content/themes/utfsoft.ru/assets/img/pages/72/banner.svg"
    ...
    <div class="container">
        ...
        <div class="items d-flex flex-wrap justify-content-between rg-block-1">
            <div class="item link-js" data-link="/spektr/">
                <img src="" data-src="/wp-content/themes/utfsoft.ru/assets/img/pages/72/products-1.svg"
            ...
            <div class="item link-js" data-link="/kiber-fajly/">
                <img src="" data-src="/wp-content/themes/utfsoft.ru/assets/img/pages/72/products-2.svg"
            ...
            <div class="item link-js" data-link="/alfadok/">
                <img src="" data-src="/wp-content/themes/utfsoft.ru/assets/img/pages/72/products-3.svg"
            ...
            <div class="item link-js" data-link="/primo-rpa/">
                <img src="" data-src="/wp-content/themes/utfsoft.ru/assets/img/pages/72/products-4.svg"
