<section class="page-45 banner rg-banner pt-0">
    <div class="container">
        <div class="content d-flex flex-column flex-md-row align-items-center justify-content-between">
            ...
            <img src="/wp-content/themes/utfsoft.ru/assets/img/pages/45/banner.svg" alt="Стахановец"
...
<section class="page-45 stahanovec-10">
    <div class="container">
        <div class="content p-50 d-flex flex-column flex-lg-row justify-content-between align-items-center rg-bg-box">
            ...
            <img src="" data-src="/wp-content/themes/utfsoft.ru/assets/img/pages/45/stahanovec-10.svg"
                 alt="Стахановец 10"
