            ...
            <div class="content rg-bg-box position-relative d-flex flex-column">
                ...
                <picture class="image">
                    <source media="(max-width:576.98px)"
                            srcset="/wp-content/themes/govorov.top/assets/img/404/404-576.svg">
                    <source media="(max-width:767.98px)"
                            srcset="/wp-content/themes/govorov.top/assets/img/404/404-768.svg">
                    <source media="(max-width:991.98px)"
                            srcset="/wp-content/themes/govorov.top/assets/img/404/404-992.svg">
                    <source media="(max-width:1199.98px)"
                            srcset="/wp-content/themes/govorov.top/assets/img/404/404-1200.svg">
                    <source media="(max-width:1399.98px)"
                            srcset="/wp-content/themes/govorov.top/assets/img/404/404-1400.svg">
                    <img src="/wp-content/themes/govorov.top/assets/img/404/404.svg" alt="404">
                </picture>
            </div>
        </div>
    </section><!-- .error-404 -->
